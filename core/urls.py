...
from core.views import UserCreate, UserDetail, AddPollToQuiz, ShowUserQuizzes, QuizCreate,QuizDetail, GamesList, add_player_to_game,delete_player_from_game, GameDetail
urlpatterns = [
